...
export default function Home() {
  ...
  const services = [
    ...
    {
      name: t("allServices.applianceRemoval.name"),
      icon: "🧺",
      image: "/placeholder.svg?height=600&width=800",
      description: t("allServices.applianceRemoval.description"),
      slug: "appliance-removal",
    },
    {
      name: t("allServices.furnitureHauling.name"),
      icon: "🛋️",
      image: "/placeholder.svg?height=600&width=800",
      description: t("allServices.furnitureHauling.description"),
      slug: "furniture-hauling",
    },
    {
      name: t("allServices.greenWaste.name"),
      icon: "🌿",
      image: "/placeholder.svg?height=600&width=800",
      description: t("allServices.greenWaste.description"),
      slug: "green-waste",
    },
    {
      name: t("allServices.constructionDebris.name"),
      icon: "🏗️",
      image: "/placeholder.svg?height=600&width=800",
      description: t("allServices.constructionDebris.description"),
      slug: "construction-debris",
    },
    {
      name: t("allServices.householdJunk.name"),
      icon: "🗑️",
      image: "/placeholder.svg?height=600&width=800",
      description: t("allServices.householdJunk.description"),
      slug: "household-junk",
    },
    {
      name: t("allServices.kitchenBathDemo.name"),
      icon: "🚿",
      image: "/placeholder.svg?height=600&width=800",
      description: t("allServices.kitchenBathDemo.description"),
      slug: "kitchen-bath-demo",
    },
    {
      name: t("allServices.junkRemoval.name"),
      icon: "📦",
      image: "/placeholder.svg?height=600&width=800",
      description: t("allServices.junkRemoval.description"),
      slug: "junk-removal",
    },
    {
      name: t("allServices.dirtRemoval.name"),
      icon: "🌱",
      image: "/placeholder.svg?height=600&width=800",
      description: t("allServices.dirtRemoval.description"),
      slug: "dirt-removal",
    },
    {
      name: t("allServices.concreteRemoval.name"),
      icon: "🧱",
      image: "/placeholder.svg?height=600&width=800",
      description: t("allServices.concreteRemoval.description"),
      slug: "concrete-removal",
    },
    {
      name: t("allServices.roofRemoval.name"),
      icon: "🏠",
      image: "/placeholder.svg?height=600&width=800",
      description: t("allServices.roofRemoval.description"),
      slug: "roof-removal",
    },
    {
      name: t("allServices.yardCleanup.name"),
      icon: "🌳",
      image: "/placeholder.svg?height=600&width=800",
      ...
      <section className="py-16 bg-white flex text-center justify-center dark:bg-[#000]">
        <div className="container px-4 md:px-6">
          <motion.div
            ...
            className="text-center mb-10"
          >
            <h2 className="text-3xl font-bold mb-3 text-green-800 dark:text-green-400">
      ...
      <section className="py-12 bg-green-700 dark:bg-green-800 text-white flex text-center justify-center">
        <div className="container px-4 md:px-6">
          ...
          >
            ...
            <Button
              size="lg"
              className="bg-white hover:bg-green-50 text-green-800"
            >
